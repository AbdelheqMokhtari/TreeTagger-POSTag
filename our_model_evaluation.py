...
tagger = treetaggerwrapper.TreeTagger(TAGPARFILE="Training/our_model.par")
...
for config in file_configs:
    ...
    if os.path.exists(file_path):
        ...
        output_file_path = os.path.join(output_folder, f"our_model_results_{file_id}.txt")
...
conf_matrix_path = os.path.join(output_folder, "our_model_confusion_matrix.csv")
...
cm2_path = os.path.join(output_folder, "our_model_confusion_matrix_2.csv")
cm2.to_csv(cm2_path)
...
classification_report_path = os.path.join(output_folder, "our_model_classification_report.json")
...
accuracy_report_path = os.path.join(output_folder, "our_model_accuracy_report.json")
